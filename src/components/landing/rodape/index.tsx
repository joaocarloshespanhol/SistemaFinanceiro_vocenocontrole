        ...
        <Area className="bg-white py-2">
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center mt-14">
                ...
                <p className="text-zinc-800 mt-7 md:mt-0 text-center">
                    <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-black to-green-500">JC Desenvolvedor Web</span> <span>® - Todos os direitos reservados</span>
